...
def register_prompt_enhance_routes(routes, register_route) -> None:
    register_route(routes, "POST", "/minimax/director_local/enhance_models", director_enhance_models)
    register_route(routes, "POST", "/minimax/director_local/get_template", director_get_template)
    register_route(routes, "POST", "/minimax/director_local/enhance", director_enhance_prompt)
    register_route(routes, "POST", "/minimax/director_local/extract_frames", director_extract_frames)
    register_route(routes, "POST", "/minimax/director_local/image_b64", director_image_b64)
    register_route(routes, "POST", "/minimax/director_local/unload_model", director_unload_model)
    register_route(routes, "POST", "/minimax/director_local/unload_ollama", director_unload_ollama)
